#!/usr/bin/env python3
"""
run_jepa_cw336_forecast.py — Pretrain JEPA (8 layers, 336-ts context) on Monash,
...
def main():
    ...
    print("=" * 60)
    print("  JEPA  cw336 forecast experiment")
    ...
    from Train_and_downstream import run_jepa
