"""
JEPA linear-probe classification — TSLib style.
...
from JEPA.Decoder import ClassificationHead  # kept for compat; not used directly
...
def classification_zeroshot(self, path, classification_train, classification_val,
    ...
    """
    Linear-probe classification with frozen JEPA encoder (TSLib style).
    ...
    print(f"\n=== JEPA Classification (TSLib linear probe) ===")
